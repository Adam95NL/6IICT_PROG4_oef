...
""" STAP 2:
De functie start_spel (zie regel 55) geeft de score terug die de speler behaald heeft.
Als deze behaalde score groter is dan de huidige highscore,
overschrijf kerst_oefening3.json zodat de highscore nu gelijk is aan deze behaalde score.

Vergeet niet om commentaar te schrijven bij iedere regel geschreven code.
"""
